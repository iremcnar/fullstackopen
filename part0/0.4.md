...
sequenceDiagram
    ...
    Note right of browser: The user writes a note into the text field and clicks "Save"
    ...
    activate server
    server-->>browser: [{ "content": "HTML is easy", "date": "2023-1-1" }, ..., { "content": "New note text", "date": "2026-9-15" }]
    deactivate server
